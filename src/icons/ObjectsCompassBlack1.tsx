...
function SvgObjectsCompassBlack1(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 100 100" fill="none" ref={svgRef} {...props}>
      ...
      />
      <Path
        d="M27.879 72.121l29.51-14.733-14.776-14.776-14.734 29.51z"
        stroke="#000"
        strokeWidth={4}
        strokeLinecap="round"
        strokeLinejoin="round"
...
const ForwardRef = React.forwardRef(SvgObjectsCompassBlack1);
