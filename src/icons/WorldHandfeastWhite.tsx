...
function SvgWorldHandfeastWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 76 101" fill="none" ref={svgRef} {...props}>
      <Path
        d="M46.293 73.453A24.133 24.133 0 0022.06 49.42h-3.426"
        stroke="#fff"
        strokeWidth={4}
        strokeLinecap="round"
      ...
      />
      <Path
        d="M74 32.935v38.433a27.608 27.608 0 01-27.708 27.46H29.708A27.609 27.609 0 012 71.367V46.54a16.486 16.486 0 0116.535-16.386h24.828a9.932 9.932 0 019.93 9.633 9.931 9.931 0 01-9.93 9.584H18.535"
        stroke="#fff"
        strokeWidth={4}
        strokeLinecap="round"
        strokeLinejoin="round"
...
const ForwardRef = React.forwardRef(SvgWorldHandfeastWhite);
