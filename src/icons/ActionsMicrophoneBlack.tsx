...
function SvgActionsMicrophoneBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 53 97" fill="none" ref={svgRef} {...props}>
      <Path d="M26.264 94.969v-16.5" stroke="#000" strokeWidth={4} strokeLinejoin="round" />
      <Path
...
const ForwardRef = React.forwardRef(SvgActionsMicrophoneBlack);
