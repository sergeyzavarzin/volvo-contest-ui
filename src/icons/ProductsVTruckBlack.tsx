...
function SvgProductsVTruckBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 104 97" fill="none" ref={svgRef} {...props}>
      ...
      />
      <Path d="M80.414 87.19v6.97h6.88v-7" fill="#000" />
      <Path
      ...
      <Path
        ...
        strokeLinejoin="round"
      />
      <Path d="M15.914 87.16v7h6.92v-6.97" fill="#000" />
      <Path
...
const ForwardRef = React.forwardRef(SvgProductsVTruckBlack);
