...
function SvgBuildingAssemlyLineWhite(
  props: SvgProps,
  ...
  return (
    <Svg viewBox="0 0 118 76" fill="none" ref={svgRef} {...props}>
      ...
      />
      <Path
        d="M26.128 14.47l1.763 23.49c.075 1.653-1.471 3.097-3.497 3.29-2.026.194-3.807-.963-4.037-2.6L15.174 8.045M31.51 44.852H16.938v7.289H31.51v-7.289z"
        stroke="#fff"
        strokeWidth={4}
        strokeLinecap="round"
        strokeLinejoin="round"
...
const ForwardRef = React.forwardRef(SvgBuildingAssemlyLineWhite);
