...
function SvgWorldHandshakeBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 110 63" fill="none" ref={svgRef} {...props}>
      ...
      <Path
        ...
        strokeLinecap="round"
      />
      <Path d="M58.76 23.084l23.085 20.987h14.69" stroke="#000" strokeWidth={4} />
      <Path
...
const ForwardRef = React.forwardRef(SvgWorldHandshakeBlack);
