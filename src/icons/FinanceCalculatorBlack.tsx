...
function SvgFinanceCalculatorBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
...
const ForwardRef = React.forwardRef(SvgFinanceCalculatorBlack);
