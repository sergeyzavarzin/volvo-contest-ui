...
function SvgDevicesMobilePhoneWhite(
  props: SvgProps,
  ...
  return (
    <Svg viewBox="0 0 58 99" fill="none" ref={svgRef} {...props}>
      ...
      />
      <Path d="M29.005 89.692a2.248 2.248 0 100-4.496 2.248 2.248 0 000 4.496z" fill="#fff" />
    </Svg>
  );
}

const ForwardRef = React.forwardRef(SvgDevicesMobilePhoneWhite);
