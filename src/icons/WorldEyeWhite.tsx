...
function SvgWorldEyeWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 112 72" fill="none" ref={svgRef} {...props}>
      <Path
        d="M55.656 57.84c12.335 0 22.335-10 22.335-22.337 0-12.335-10-22.335-22.335-22.335-12.336 0-22.336 10-22.336 22.335 0 12.336 10 22.336 22.336 22.336z"
        stroke="#fff"
        strokeWidth={4}
        strokeLinecap="round"
...
const ForwardRef = React.forwardRef(SvgWorldEyeWhite);
