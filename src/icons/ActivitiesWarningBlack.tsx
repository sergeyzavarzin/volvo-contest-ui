...
function SvgActivitiesWarningBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
...
const ForwardRef = React.forwardRef(SvgActivitiesWarningBlack);
