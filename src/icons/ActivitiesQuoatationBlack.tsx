...
function SvgActivitiesQuoatationBlack(
  props: SvgProps,
  ...
  return (
    <Svg viewBox="0 0 86 111" fill="none" ref={svgRef} {...props}>
      <Path
        d="M60.56 10.18H25.13a2.72 2.72 0 00-2.73 2.72v8.18a2.73 2.73 0 002.73 2.73h35.43a2.73 2.73 0 002.73-2.73V12.9a2.72 2.72 0 00-2.73-2.72z"
        stroke="#000"
        strokeWidth={4}
        strokeLinecap="round"
...
const ForwardRef = React.forwardRef(SvgActivitiesQuoatationBlack);
