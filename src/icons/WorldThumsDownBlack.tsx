...
function SvgWorldThumsDownBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 101 96" fill="none" ref={svgRef} {...props}>
      <Path
        d="M2 55.99h16.432V6.694H2v49.294z"
        stroke="#000"
        strokeWidth={4}
        strokeLinecap="round"
...
const ForwardRef = React.forwardRef(SvgWorldThumsDownBlack);
