...
function SvgWorldGlobeWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 116 116" fill="none" ref={svgRef} {...props}>
      ...
      <Path
        ...
        strokeLinecap="round"
      />
      <Path d="M4.41 40.71h106.45M4.41 74.58h106.45" stroke="#fff" strokeWidth={3.77} />
    </Svg>
  );
}

const ForwardRef = React.forwardRef(SvgWorldGlobeWhite);
