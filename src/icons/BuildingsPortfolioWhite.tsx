...
function SvgBuildingsPortfolioWhite(
  props: SvgProps,
  ...
  return (
    <Svg viewBox="0 0 105 85" fill="none" ref={svgRef} {...props}>
      ...
      />
      <Path
        d="M88.13 16.228V42.62a3.872 3.872 0 01-3.872 3.872h-64.46a3.871 3.871 0 01-3.87-3.872V16.228"
        stroke="#fff"
        strokeWidth={4}
        strokeMiterlimit={10}
      />
...
const ForwardRef = React.forwardRef(SvgBuildingsPortfolioWhite);
