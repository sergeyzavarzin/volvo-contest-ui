...
function SvgWorldCloudUploadWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 111 72" fill="none" ref={svgRef} {...props}>
      <Path
        d="M59 57.125v-28M46 42l13-13 13 13"
        stroke="#fff"
        strokeWidth={4}
        strokeMiterlimit={10}
        strokeLinecap="round"
...
const ForwardRef = React.forwardRef(SvgWorldCloudUploadWhite);
