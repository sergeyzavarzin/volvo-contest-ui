...
function SvgProductsCeCrawlerBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 113 76" fill="none" ref={svgRef} {...props}>
      ...
      />
      <Path
        d="M67.158 47.948l13.54-8.13h24.28l2.48.42 2.55 3-1.06 2a32.356 32.356 0 011.86 9.42 3.811 3.811 0 01-.94 2.9h-32.31v4h-19.16v-4h-7.26s0-.21-.07-.52l8.28-1.81 7.81-7.29M58.398 57.519h20.18"
        stroke="#000"
        strokeWidth={4}
        strokeLinejoin="round"
      />
...
const ForwardRef = React.forwardRef(SvgProductsCeCrawlerBlack);
