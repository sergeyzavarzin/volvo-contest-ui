...
function SvgObjectsMobilePhoneBlack(
  props: SvgProps,
  ...
  return (
    <Svg viewBox="0 0 69 107" fill="none" ref={svgRef} {...props}>
      ...
      <Path
        ...
        strokeLinejoin="round"
      />
      <Path d="M34.007 96.79a2.46 2.46 0 100-4.92 2.46 2.46 0 000 4.92z" fill="#000" />
    </Svg>
  );
}

const ForwardRef = React.forwardRef(SvgObjectsMobilePhoneBlack);
