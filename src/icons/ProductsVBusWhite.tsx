...
function SvgProductsVBusWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 97 101" fill="none" ref={svgRef} {...props}>
      <Path
        ...
        strokeWidth={4}
      />
      <Path d="M23.586 88.94v7.79a1 1 0 01-1 1h-6.86a1 1 0 01-1.05-1v-8.79" fill="#fff" />
      <Path
        d="M23.586 88.94v7.79a1 1 0 01-1 1h-6.86a1 1 0 01-1.05-1v-8.79"
        stroke="#fff"
        strokeWidth={4.91}
      />
      <Path d="M72.696 88.94v7.79a1 1 0 001 1h6.82a1 1 0 001-1v-8.79" fill="#fff" />
      <Path
...
const ForwardRef = React.forwardRef(SvgProductsVBusWhite);
