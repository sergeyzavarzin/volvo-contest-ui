...
function SvgObjectsSpeedWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 112 90" fill="none" ref={svgRef} {...props}>
      ...
      <Path
        ...
        strokeLinejoin="round"
      />
      <Path d="M62.762 53.561L95.479 39.54" stroke="#fff" strokeWidth={4} strokeLinecap="round" />
    </Svg>
  );
}

const ForwardRef = React.forwardRef(SvgObjectsSpeedWhite);
