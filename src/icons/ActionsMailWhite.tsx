...
function SvgActionsMailWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 108 68" fill="none" ref={svgRef} {...props}>
      <Path
        ...
        strokeMiterlimit={10}
      />
      <Path d="M2 5.54L53.69 43l51.7-37.41" stroke="#fff" strokeWidth={4} strokeMiterlimit={10} />
    </Svg>
  );
}

const ForwardRef = React.forwardRef(SvgActionsMailWhite);
