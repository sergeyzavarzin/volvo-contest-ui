...
function SvgPeopleOperatorWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 95 102" fill="none" ref={svgRef} {...props}>
      ...
      <Path
        ...
        strokeLinejoin="round"
      />
      <Path d="M48.8 82.566l36.93-2.46" stroke="#fff" strokeWidth={4} strokeLinejoin="round" />
      <Path
...
const ForwardRef = React.forwardRef(SvgPeopleOperatorWhite);
