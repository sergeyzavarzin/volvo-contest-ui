...
function SvgObjectsCaseBlack(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
    <Svg viewBox="0 0 108 88" fill="none" ref={svgRef} {...props}>
      <G
        clipPath="url(#ObjectsCaseBlack_svg__clip0)"
        stroke="#000"
        strokeWidth={4}
        strokeMiterlimit={10}>
      ...
      <Defs>
        <ClipPath id="ObjectsCaseBlack_svg__clip0">
...
const ForwardRef = React.forwardRef(SvgObjectsCaseBlack);
