...
function SvgTransportationCarWhite(props: SvgProps, svgRef?: React.Ref<React.Component<SvgProps>>) {
  return (
...
const ForwardRef = React.forwardRef(SvgTransportationCarWhite);
